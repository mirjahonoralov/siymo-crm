...
import { contactActionT } from "../../../store/slices/contactSlice";
...
const ContactAction: React.FC<T> = ({ item, handleChange, expanded }) => {
  const { manager, steps, created_at, survey, applications } = item;
